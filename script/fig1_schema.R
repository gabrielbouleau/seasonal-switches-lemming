...
# text("$R_1 = e^{r_1 q} e^{r_2 (1-q)}$", x = 1.9, y = 1.8, cex = 3)
# text("$R_2 = e^{r_1 q} e^{r_3 (1-q)}$", x = 5.7, y = 3.2, cex = 3)
...
tikzAnnotate(c('\\definecolor{winter}{RGB}{33,176,192}', # Define color for the color insertion
               ...
               '{$R_1 = e^{\\textcolor{winter}{r_1} q} e^{\\textcolor{low_summer}{r_2} (1-q)}$};',
               ...
               '{$R_2 = e^{\\textcolor{winter}{r_1} q} e^{\\textcolor{high_summer}{r_3} (1-q)}$};')
)
